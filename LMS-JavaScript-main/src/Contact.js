...
function Body(){
  ...
  <div style={{marginLeft: '200px', marginRight: '200px', textAlign: 'center'}}>
    <br/><br/><h1 style={{color:'white'}}>We are available for you 24/7. You can contact us:</h1><br/><br/>
    <div>
        <h2><i className='fab fa-whatsapp' style={{fontSize:'20px'}}></i> whatsapp: 071-9078601</h2><br/>
    </div>
    <div>
        <h2><FacebookFilled /> Facebook: ReaderLibrary</h2><br/>
    </div>
    <div>
        <h2><MailFilled /> Email: reader.library@hotmail.com</h2>
    </div>
    <div>
